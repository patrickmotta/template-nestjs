...
@Injectable()
export default class PGLogsConfigDatabase implements TypeOrmOptionsFactory {
	constructor(private configService: ConfigService) {}
	private DBHost = this.getEnv('PG_LOGS_DB_HOST')
	private DBPort = this.getEnv('PG_LOGS_DB_PORT')
